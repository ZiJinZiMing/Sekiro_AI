...
REGISTER_DBG_GOAL_PARAM(GOAL_EnemyChainAttack, 1, "コンボ確率", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_EnemyChainAttack, 2, "攻撃1", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_EnemyChainAttack, 3, "攻撃2", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_EnemyChainAttack, 4, "攻撃3", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_EnemyChainAttack, 5, "攻撃4", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_EnemyChainAttack, 6, "攻撃5", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_EnemyChainAttack, 7, "攻撃6", 0)
