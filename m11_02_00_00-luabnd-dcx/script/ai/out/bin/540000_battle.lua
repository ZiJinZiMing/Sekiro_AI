...
Goal.Activate = function (f2_arg0, f2_arg1, f2_arg2)
    ...
    if f2_arg1:GetNumber(11) == 1 and f2_arg1:GetTimer(11) <= 0 and f2_local3 > 4 then
        f2_local0[15] = 100000
        f2_arg1:SetTimer(11, 30)
...
Goal.Act06 = function (f8_arg0, f8_arg1, f8_arg2)
    ...
    f8_arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3004, TARGET_ENE_0, 9999, TurnTime, FrontAngle, 0, 0)
...
Goal.Act09 = function (f11_arg0, f11_arg1, f11_arg2)
    ...
    if f11_local0 <= 0.66 then
        f11_arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3044, TARGET_ENE_0, 9999, f11_local1, f11_local2, 0, 0)
    end
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act14 = function (f16_arg0, f16_arg1, f16_arg2)
    f16_arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 0.3, 3044, TARGET_ENE_0, 999, TurnTime, FrontAngle, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act39 = function (f35_arg0, f35_arg1, f35_arg2)
    ...
    local f35_local3 = f35_arg0:GetRandam_Int(30, 45)
    if SpaceCheck(f35_arg0, f35_arg1, 180, 5) then
        f35_arg1:AddSubGoal(GOAL_COMMON_SpinStep, f35_local0, 5201, TARGET_ENE_0, f35_local1, AI_DIR_TYPE_B, 0)
        f35_local2 = 3.5
    end
    local f35_local4 = 0
    ...
    f35_arg1:AddSubGoal(GOAL_COMMON_SidewayMove, f35_local2, TARGET_ENE_0, f35_local4, f35_local3, true, true, -1)
    return GETWELLSPACE_ODDS
    
end

Goal.Act40 = function (f36_arg0, f36_arg1, f36_arg2)
    f36_arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3015, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Interrupt = function (f37_arg0, f37_arg1, f37_arg2)
    ...
    local f37_local3 = f37_arg1:GetSpecialEffectInactivateInterruptType(0)
    local f37_local4 = f37_arg1:GetSpRate(TARGET_SELF)
    ...
    if f37_arg1:IsInterupt(INTERUPT_ParryTiming) then
        return Common_Parry(f37_arg1, f37_arg2, 100, 0, 1, 3102)
    end
    if f37_arg1:IsInterupt(INTERUPT_Shoot) then
    ...
    if Interupt_Use_Item(f37_arg1, 10, 10) and f37_arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 180) then
        if f37_local1 < 10 then
            f37_arg2:ClearSubGoal()
            f37_arg2:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 1, 3024, TARGET_ENE_0, 9999, 0)
            return true
        else
            f37_arg1:Replanning()
            return true
    ...
    if f37_arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        if f37_local0 == 5025 then
            if f37_local1 <= 3 then
                f37_arg2:ClearSubGoal()
                f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 0.5, 3041, TARGET_ENE_0, 999, 0, 0, 0, 0)
                do
                    return true
                end
                if false then
        ...
        elseif f37_local0 == 5027 then
            f37_arg2:ClearSubGoal()
            f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3008, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        elseif f37_local0 == 5028 then
            if f37_local1 <= 2.5 - f37_arg1:GetMapHitRadius(TARGET_SELF) - 0.5 then
                f37_arg2:ClearSubGoal()
                f37_arg2:AddSubGoal(GOAL_COMMON_EndureAttack, 10, 3017, TARGET_ENE_0, 999, 0, 0, 0, 0)
                return true
            end
        elseif f37_local0 == 5029 then
            if f37_local1 <= 11 then
                f37_arg2:ClearSubGoal()
                f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3021, TARGET_ENE_0, 999, 0, 0, 0, 0)
                return true
            end
        ...
        elseif f37_local0 == 5032 and f37_local1 <= 3 - f37_arg1:GetMapHitRadius(TARGET_SELF) then
            f37_arg2:ClearSubGoal()
            f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 3, 3077, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        elseif f37_local0 == 5034 and f37_arg1:HasSpecialEffectId(TARGET_SELF, 200050) then
            if f37_local2 <= 60 then
                if f37_local1 <= 4.2 - f37_arg1:GetMapHitRadius(TARGET_SELF) and f37_arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 120) then
                    f37_arg2:ClearSubGoal()
                    f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 3, 3012, TARGET_ENE_0, 999, 0, 0, 0, 0)
                    return true
                elseif f37_local1 <= 4.2 - f37_arg1:GetMapHitRadius(TARGET_SELF) and f37_arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 120) then
                    f37_arg2:ClearSubGoal()
                    f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 3, 3012, TARGET_ENE_0, 999, 0, 0, 0, 0)
                    return true
                elseif f37_local1 <= 4 - f37_arg1:GetMapHitRadius(TARGET_SELF) and f37_arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 240) then
                    f37_arg2:ClearSubGoal()
                    f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 3, 3023, TARGET_ENE_0, 999, 0, 0, 0, 0)
                    return true
                end
            end
        elseif f37_local0 == 5036 then
            if f37_local2 <= 100 then
                f37_arg2:ClearSubGoal()
                f37_arg2:AddSubGoal(GOAL_COMMON_EndureAttack, 3, 3041, TARGET_ENE_0, 9999, 0)
                return true
            end
        elseif f37_local0 == 5037 and f37_local1 <= 4 - f37_arg1:GetMapHitRadius(TARGET_SELF) and not f37_arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_R, 90) then
            if f37_local2 <= 50 then
                f37_arg2:ClearSubGoal()
                f37_arg2:AddSubGoal(GOAL_COMMON_EndureAttack, 1, 3023, TARGET_ENE_0, 9999, 0)
                return true
            end
        elseif f37_local0 == 5038 then
            if f37_local1 <= 3.5 then
                f37_arg2:ClearSubGoal()
                f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 3, 3104, TARGET_ENE_0, 999, 0, 0, 0, 0)
            end
        elseif f37_local0 == 5039 and f37_local4 <= 0.5 then
            f37_arg2:ClearSubGoal()
            f37_arg2:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3045, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        elseif f37_local0 == 110112 and f37_arg1:HasSpecialEffectId(TARGET_SELF, 3540020) then
            f37_arg2:ClearSubGoal()
            f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 0.1, 3046, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        elseif f37_local0 == 110113 and f37_arg1:HasSpecialEffectId(TARGET_SELF, 3540020) then
            f37_arg2:ClearSubGoal()
            f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 0.1, 3049, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        elseif f37_local0 == 110114 and f37_arg1:HasSpecialEffectId(TARGET_SELF, 3540020) then
            f37_arg2:ClearSubGoal()
            f37_arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 0.1, 3048, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
...
Goal.Kengeki_Activate = function (f39_arg0, f39_arg1, f39_arg2, f39_arg3)
    ...
    local f39_local5 = f39_arg1:GetSpRate(TARGET_SELF)
    local f39_local6 = f39_arg1:GetNinsatsuNum()
    if f39_local5 <= 0 then
        f39_local1[50] = 100
    else
        f39_arg1:SetNumber(0, f39_arg1:GetNumber(0) + 1)
        if f39_local6 <= 2 and f39_arg1:HasSpecialEffectId(TARGET_SELF, 200050) then
            f39_local1[40] = 100
        elseif f39_local0 == 200205 or f39_local0 == 200200 then
            f39_local1[2] = 100
            if f39_arg1:GetNumber(0) >= 2 then
                f39_local1[6] = 100
                f39_local1[7] = 100
                f39_local1[8] = 100
                f39_local1[20] = 200
        ...
        elseif f39_local0 == 200210 then
            ...
            f39_local1[11] = 100
            f39_local1[4] = 100
            if f39_arg1:HasSpecialEffectId(TARGET_ENE_0, 110600) then
                f39_local1[8] = 500
                f39_local1[4] = 500
            elseif f39_arg1:HasSpecialEffectId(TARGET_ENE_0, 110610) then
                f39_local1[8] = 500
                f39_local1[4] = 500
            end
        elseif f39_local0 == 200226 then
            if f39_arg1:HasSpecialEffectId(TARGET_SELF, 200050) then
                f39_local1[30] = 100
            else
                f39_local1[50] = 100
            end
        elseif f39_local0 == 200229 and f39_arg1:GetNumber(0) >= 5 then
    ...
    if f39_arg1:IsFinishTimer(2) == false then
        f39_local1[5] = 0
        f39_local1[6] = 0
    end
    if f39_arg1:HasSpecialEffectId(TARGET_SELF, 200050) then
        f39_local1[20] = 0
    elseif f39_arg1:HasSpecialEffectId(TARGET_SELF, 200051) then
        f39_local1[5] = 0
    end
    if SpaceCheck(f39_arg1, f39_arg2, 45, 2) == false and SpaceCheck(f39_arg1, f39_arg2, -45, 2) == false then
        f39_local1[22] = 0
    end
    if SpaceCheck(f39_arg1, f39_arg2, 180, 2) == false then
        f39_local1[24] = 0
    end
    f39_local1[1] = SetCoolTime(f39_arg1, f39_arg2, 3071, 8, f39_local1[1], 1)
    f39_local1[2] = SetCoolTime(f39_arg1, f39_arg2, 3060, 8, f39_local1[2], 1)
    f39_local1[3] = SetCoolTime(f39_arg1, f39_arg2, 3075, 8, f39_local1[3], 1)
    f39_local1[4] = SetCoolTime(f39_arg1, f39_arg2, 3007, 12, f39_local1[4], 1)
    f39_local1[4] = SetCoolTime(f39_arg1, f39_arg2, 3072, 12, f39_local1[4], 1)
    f39_local1[4] = SetCoolTime(f39_arg1, f39_arg2, 3077, 12, f39_local1[4], 1)
    f39_local1[5] = SetCoolTime(f39_arg1, f39_arg2, 3009, 12, f39_local1[5], 1)
    f39_local1[6] = SetCoolTime(f39_arg1, f39_arg2, 3011, 12, f39_local1[6], 1)
    f39_local1[7] = SetCoolTime(f39_arg1, f39_arg2, 3026, 8, f39_local1[7], 1)
    f39_local1[8] = SetCoolTime(f39_arg1, f39_arg2, 5201, 15, f39_local1[8], 1)
    f39_local1[9] = SetCoolTime(f39_arg1, f39_arg2, 3071, 15, f39_local1[9], 1)
    f39_local1[11] = SetCoolTime(f39_arg1, f39_arg2, 3003, 15, f39_local1[11], 1)
    f39_local1[12] = SetCoolTime(f39_arg1, f39_arg2, 3005, 8, f39_local1[12], 1)
    f39_local1[13] = SetCoolTime(f39_arg1, f39_arg2, 3016, 8, f39_local1[13], 1)
    f39_local1[14] = SetCoolTime(f39_arg1, f39_arg2, 3077, 8, f39_local1[14], 1)
    f39_local1[15] = SetCoolTime(f39_arg1, f39_arg2, 3011, 15, f39_local1[15], 1)
    f39_local1[17] = SetCoolTime(f39_arg1, f39_arg2, 3009, 8, f39_local1[17], 1)
    f39_local1[20] = SetCoolTime(f39_arg1, f39_arg2, 5201, 10, f39_local1[20], 1)
    f39_local1[21] = SetCoolTime(f39_arg1, f39_arg2, 3050, 15, f39_local1[21], 1)
    f39_local1[22] = SetCoolTime(f39_arg1, f39_arg2, 3044, 15, f39_local1[22], 1)
    f39_local1[31] = SetCoolTime(f39_arg1, f39_arg2, 3072, 15, f39_local1[22], 1)
    ...
    f39_local2[13] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki13)
    f39_local2[14] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki14)
    f39_local2[15] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki15)
    f39_local2[16] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki16)
    f39_local2[17] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki17)
    f39_local2[18] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki18)
    f39_local2[19] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki19)
    f39_local2[20] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki20)
    f39_local2[21] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki21)
    f39_local2[22] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki22)
    f39_local2[23] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki23)
    f39_local2[24] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki24)
    f39_local2[25] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki25)
    f39_local2[26] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki26)
    f39_local2[30] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki30)
    f39_local2[31] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki31)
    f39_local2[40] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.Kengeki40)
    f39_local2[50] = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.NoAction)
    local f39_local7 = REGIST_FUNC(f39_arg1, f39_arg2, f39_arg0.ActAfter_AdjustSpace)
    return Common_Kengeki_Activate(f39_arg1, f39_arg2, f39_local1, f39_local2, f39_local7, f39_local3)
    
end

Goal.Kengeki01 = function (f40_arg0, f40_arg1, f40_arg2)
    f40_arg1:ClearSubGoal()
    f40_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3070, TARGET_ENE_0, 9999, 0, 0)
    
end

Goal.Kengeki02 = function (f41_arg0, f41_arg1, f41_arg2)
    f41_arg1:ClearSubGoal()
    f41_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3060, TARGET_ENE_0, 9999, 0, 0)
    f41_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3001, TARGET_ENE_0, 9999, 0, 0)
    f41_arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3002, TARGET_ENE_0, 9999, 0, 0)
...
Goal.Kengeki03 = function (f42_arg0, f42_arg1, f42_arg2)
    ...
    f42_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3075, TARGET_ENE_0, 2.8 - f42_arg0:GetMapHitRadius(TARGET_SELF), 0, 0)
    f42_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3001, TARGET_ENE_0, 3.8 - f42_arg0:GetMapHitRadius(TARGET_SELF), 0, 0)
...
Goal.Kengeki04 = function (f43_arg0, f43_arg1, f43_arg2)
    ...
    f43_arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3072, TARGET_ENE_0, 9999, 0, 0)
...
Goal.Kengeki05 = function (f44_arg0, f44_arg1, f44_arg2)
    ...
    local f44_local1 = 10
    local f44_local2 = f44_arg0:GetRandam_Int(1, 100)
    local f44_local3 = -1
    local f44_local4 = f44_arg0:GetRandam_Int(30, 60)
    local f44_local5 = f44_arg0:GetRandam_Int(1, 100)
    local f44_local6 = 1
    f44_arg1:ClearSubGoal()
    f44_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3009, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    if f44_local5 <= 100 then
        f44_arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3044, TARGET_ENE_0, 9999, 0, 0, 0, 0):TimingSetTimer(2, 15, AI_TIMING_SET__UPDATE_SUCCESS)
    end
    f44_arg0:SetNumber(0, 0)
    
end

Goal.Kengeki06 = function (f45_arg0, f45_arg1, f45_arg2)
    f45_arg1:ClearSubGoal()
    f45_arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3011, TARGET_ENE_0, 9999, 0, 0)
    f45_arg0:SetNumber(0, 0)
    
end

Goal.Kengeki07 = function (f46_arg0, f46_arg1, f46_arg2)
    f46_arg1:ClearSubGoal()
    f46_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3018, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    f46_arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3026, TARGET_ENE_0, 9999, 0, 0, 0, 0)
...
Goal.Kengeki08 = function (f47_arg0, f47_arg1, f47_arg2)
    ...
    f47_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 5201, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    f47_arg0:SetNumber(11, 1)
    f47_arg0:SetNumber(1, 1)
    
end

Goal.Kengeki09 = function (f48_arg0, f48_arg1, f48_arg2)
    f48_arg1:ClearSubGoal()
    f48_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3071, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    f48_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3001, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    f48_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3002, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    
end

Goal.Kengeki11 = function (f49_arg0, f49_arg1, f49_arg2)
    f49_arg1:ClearSubGoal()
    f49_arg1:AddSubGoal(GOAL_COMMON_EndureAttack, 10, 3003, TARGET_ENE_0, 9999, 0)
    
end

Goal.Kengeki20 = function (f50_arg0, f50_arg1, f50_arg2)
    f50_arg1:ClearSubGoal()
    f50_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3009, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    
end

Goal.Kengeki21 = function (f51_arg0, f51_arg1, f51_arg2)
    f51_arg1:ClearSubGoal()
    f51_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3050, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    
end

Goal.Kengeki30 = function (f52_arg0, f52_arg1, f52_arg2)
    f52_arg1:ClearSubGoal()
    f52_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3045, TARGET_ENE_0, 9999, 0, 0, 0, 0):TimingSetTimer(2, 15, AI_TIMING_SET__UPDATE_SUCCESS)
    f52_arg0:SetNumber(11, 0)
    
end

Goal.Kengeki31 = function (f53_arg0, f53_arg1, f53_arg2)
    f53_arg1:ClearSubGoal()
    f53_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3072, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    
end

Goal.Kengeki40 = function (f54_arg0, f54_arg1, f54_arg2)
    f54_arg1:ClearSubGoal()
    f54_arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3015, TARGET_ENE_0, 9999, 0, 0)
