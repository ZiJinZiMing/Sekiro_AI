...
Goal.Act31 = function (f21_arg0, f21_arg1, f21_arg2)
    local f21_local0 = 0
    local f21_local1 = 0
    local f21_local2 = f21_arg0:GetNumber(0)
    local f21_local3 = 7.5
    if f21_local2 == 1 then
        f21_arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 3, TARGET_ENE_0, f21_local3, TARGET_SELF, true, -1)
        f21_arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3043, TARGET_ENE_0, 9999, f21_local0, f21_local1, 0, 0):SetFailedEndOption(AI_GOAL_FAILED_END_OPT__PARENT_NEXT_SUB_GOAL)
        f21_arg1:AddSubGoal(GOAL_COMMON_ApproachSettingDirection, 0.5, TARGET_SELF, 2, TARGET_SELF, false, -1, AI_DIR_TYPE_F, 10)
        f21_arg1:AddSubGoal(GOAL_COMMON_ApproachSettingDirection, 1, TARGET_ENE_0, 1, TARGET_SELF, false, -1, AI_DIR_TYPE_ToL, 20)
        f21_arg0:SetNumber(0, 2)
    elseif f21_local2 == 2 then
        f21_arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 3, TARGET_ENE_0, f21_local3, TARGET_SELF, false, -1)
        f21_arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3044, TARGET_ENE_0, 9999, f21_local0, f21_local1, 0, 0):SetFailedEndOption(AI_GOAL_FAILED_END_OPT__PARENT_NEXT_SUB_GOAL)
        f21_arg1:AddSubGoal(GOAL_COMMON_ApproachSettingDirection, 0.5, TARGET_SELF, 2, TARGET_SELF, true, -1, AI_DIR_TYPE_F, 10)
        f21_arg1:AddSubGoal(GOAL_COMMON_ApproachSettingDirection, 1, TARGET_ENE_0, 1, TARGET_SELF, true, -1, AI_DIR_TYPE_ToR, 20)
        f21_arg0:SetNumber(0, 1)
    else
...
Goal.Interrupt = function (f22_arg0, f22_arg1, f22_arg2)
    ...
    if f22_arg1:IsInterupt(INTERUPT_EventRequest) then
        local f22_local1 = f22_arg1:GetEventRequest()
    ...
    if f22_arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        ...
        local f22_local2 = f22_arg1:GetDist(TARGET_ENE_0)
        if f22_local0 == 3507002 then
            f22_arg1:SetEventFlag(11005933, true)
            return false
