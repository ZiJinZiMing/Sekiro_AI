-- ====================================================================================================
-- 102000_battle.lua - 武士大将 (Samurai General) 战斗AI - BOSS级敌人
-- ====================================================================================================
-- 敌人类型: 武士大将 (Samurai Taisho) - BOSS级战斗敌人
-- 地图区域: m11_01_00_00 (苇名城)
-- 战斗风格: 高难度多阶段战斗，具备完整的招式库和反击系统
-- 主要特点:
--   - 16+种攻击模式: 连击、横扫、突刺、特殊技等
--   - 剑戟系统: 完整的弹反与反击机制 (13种弹反反击)
--   - 进阶防御: 智能格挡判断与破防应对
--   - 忍具应对: 可使用忍具进行反制
--   - 多阶段AI: 根据HP/特效变化调整战术
--   - 观察系统: 多维度监听敌人状态与位置
--   - 距离分层: 7米/5米/3米/1米多阶段精细控制
--   - 特殊技能: 冲刺、后跳、侧向移动等战术动作
-- ====================================================================================================
...
-- 激活函数 - 核心战斗决策逻辑
-- ====================================================================================================
-- 功能: 根据多维度状态参数选择最优战斗行动
-- 流程: 观察清理 -> 特效监听 -> 剑戟检查 -> 状态获取 -> 多重条件决策 -> 空间检查 -> 冷却管理 -> 行为激活
-- 复杂度: BOSS级 - 包含忍具应对、弹反系统、多阶段转换
-- ====================================================================================================
