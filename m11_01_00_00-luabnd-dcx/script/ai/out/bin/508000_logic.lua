...
Logic.Main = function (f1_arg0, f1_arg1)
    ...
    if f1_arg1:IsFindState() or f1_arg1:IsBattleState() then
        if f1_arg1:HasSpecialEffectId(TARGET_SELF, 200004) then
            if f1_arg1:GetStringIndexedNumber("findFlag") == 0 then
                f1_arg1:AddTopGoal(GOAL_COMMON_EndureAttack, 0.1, 401040, TARGET_ENE_0, 9999, 0, 0, 0, 0)
                if false then
                end
            end
    ...
    elseif f1_arg1:IsCautionState() then
        ...
        if f1_arg1:HasSpecialEffectId(TARGET_SELF, 200004) then
            f1_arg1:AddTopGoal(GOAL_COMMON_Wait, f1_arg1:GetRandam_Float(0, 2), TARGET_SELF, 0, 0, 0)
            f1_arg1:AddTopGoal(GOAL_COMMON_AttackTunableSpin, 3, 401000, TARGET_SELF, 9999, 0, 0, 0, 0)
        elseif f1_arg1:HasSpecialEffectId(TARGET_SELF, 200002) then
        else
        end
        f1_arg1:SetStringIndexedNumber("findFlag", 0)
