...
Goal.Act36 = function (f17_arg0, f17_arg1, f17_arg2)
    ...
    if f17_local1 <= 34 then
        f17_arg0:SetEventMoveTarget(1502296)
    elseif f17_local1 <= 67 then
        f17_arg0:SetEventMoveTarget(1502297)
    else
        f17_arg0:SetEventMoveTarget(1502298)
    end
...
Goal.ActAfter_AdjustSpace = function (f21_arg0, f21_arg1, f21_arg2)
    f21_arg1:AddSubGoal(GOAL_MurabitoZombie_kumade_150010_AfterAttackAct, 10)
