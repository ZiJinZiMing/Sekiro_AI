...
Goal.Act30 = function (f13_arg0, f13_arg1, f13_arg2)
    ...
    f13_arg1:AddSubGoal(GOAL_COMMON_SidewayMove, f13_local0, TARGET_ENE_0, f13_local2, f13_local1, true, true, -1)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
    
end

Goal.Act35 = function (f14_arg0, f14_arg1, f14_arg2)
    local f14_local0 = f14_arg0:GetDist(TARGET_ENE_0)
    local f14_local1 = f14_arg0:GetRandam_Int(1, 100)
    local f14_local2 = f14_arg0:GetRandam_Int(0, 1)
    local f14_local3 = f14_arg0:GetRandam_Float(2, 3.5)
    local f14_local4 = 3
    local f14_local5 = 0
    local f14_local6 = f14_arg0:GetDist(TARGET_FRI_0)
    local f14_local7 = f14_arg0:GetRandam_Int(1, 100)
    local f14_local8 = f14_arg0:GetRandam_Float(6.5, 7.5)
    local f14_local9 = f14_arg0:GetRandam_Float(5.5, 6.5)
    local f14_local10 = 999
    local f14_local11 = 100
    if f14_local0 >= 10 then
        Approach_Act(f14_arg0, f14_arg1, f14_local8, f14_local10, 0, 3)
    elseif f14_local0 >= 5 then
    elseif f14_local0 >= 3.5 then
        f14_arg1:AddSubGoal(GOAL_COMMON_LeaveTarget, 3, TARGET_ENE_0, f14_local8, TARGET_ENE_0, false, 9910)
    else
        f14_arg1:AddSubGoal(GOAL_COMMON_SpinStep, 5, 5201, TARGET_ENE_0, 0, AI_DIR_TYPE_B, 2)
    end
    f14_arg1:AddSubGoal(GOAL_COMMON_SidewayMove, f14_local3, TARGET_ENE_0, f14_local2, f14_arg0:GetRandam_Int(30, 45), true, true, 9910):TimingSetTimer(2, 4, UPDATE_SUCCESS)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
    
end

Goal.Act36 = function (f15_arg0, f15_arg1, f15_arg2)
    local f15_local0 = -0.5
    f15_arg0:SetEventMoveTarget(1502251)
    f15_arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 3, POINT_EVENT, f15_local0, POINT_EVENT, false, -1)
...
Goal.Parry = function (f17_arg0, f17_arg1, f17_arg2)
    ...
    elseif f17_arg0:IsTargetGuard(TARGET_SELF) then
        if f17_arg0:HasSpecialEffectId(TARGET_ENE_0, 109970) then
            ...
            f17_arg1:AddSubGoal(GOAL_COMMON_EndureAttack, 0.1, 3100, TARGET_ENE_0, 9999, 0)
            return true
        end
    elseif f17_arg0:HasSpecialEffectId(TARGET_ENE_0, 109970) then
        f17_arg1:ClearSubGoal()
        f17_arg1:AddSubGoal(GOAL_COMMON_EndureAttack, 0.1, 3101, TARGET_ENE_0, 9999, 0)
        return true
    else
        f17_arg1:ClearSubGoal()
        f17_arg1:AddSubGoal(GOAL_COMMON_EndureAttack, 0.1, 3100, TARGET_ENE_0, 9999, 0)
...
Goal.Damaged = function (f18_arg0, f18_arg1, f18_arg2)
    local f18_local0 = f18_arg0:GetHpRate(TARGET_SELF)
    ...
    if f18_local3 <= 33 then
        ...
        f18_arg1:AddSubGoal(GOAL_COMMON_SpinStep, StepLife, 5211, TARGET_ENE_0, TurnTime, AI_DIR_TYPE_B, 0):TimingSetTimer(3, 6, UPDATE_SUCCESS)
        return true
